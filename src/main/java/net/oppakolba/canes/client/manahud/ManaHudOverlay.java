package net.oppakolba.canes.client.manahud;
...
public class ManaHudOverlay {
    public static final ResourceLocation MANA_TRAIT = new ResourceLocation(Canes.MOD_ID,
            "textures/mana/mana_trait.png");
    public static final ResourceLocation MANA_SHELL = new ResourceLocation(Canes.MOD_ID,
            "textures/mana/mana_shell.png");
    public static final ResourceLocation MANA_SHELL4 = new ResourceLocation(Canes.MOD_ID,
            "textures/mana/mana_shell4.png");
    public static final ResourceLocation MANA_SHELL3 = new ResourceLocation(Canes.MOD_ID,
            "textures/mana/mana_shell3.png");
    public static final ResourceLocation MANA_SHELL2 = new ResourceLocation(Canes.MOD_ID,
            "textures/mana/mana_shell2.png");
    public static final ResourceLocation MANA_SHELL1 = new ResourceLocation(Canes.MOD_ID,
