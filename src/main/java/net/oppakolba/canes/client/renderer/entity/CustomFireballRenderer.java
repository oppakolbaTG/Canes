...
import net.oppakolba.canes.client.model.bolt.CustomFireballModel;
...
public class CustomFireballRenderer extends EntityRenderer<FireballEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Canes.MOD_ID, "textures/entity/custom_fireball.png");
