...
//import net.oppakolba.canes.client.model.seal.FireBallSealModel;
//import net.oppakolba.canes.entity.projectile.FireballSeal;
//import org.jetbrains.annotations.NotNull;
//
//
//@OnlyIn(Dist.CLIENT)
//public class FireballSealRenderer extends EntityRenderer<FireballSeal> {
//    private static final ResourceLocation TEXTURE = new ResourceLocation(canes.MOD_ID, "textures/entity/fireball_seal.png");
