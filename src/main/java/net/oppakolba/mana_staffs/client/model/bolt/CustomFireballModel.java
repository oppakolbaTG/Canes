package net.oppakolba.mana_staffs.client.model.bolt;
...
public class CustomFireballModel<T extends Entity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bb_main = partdefinition.addOrReplaceChild("fireball", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -24.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
