...
import net.oppakolba.mana_staffs.client.model.bolt.BeamEntityModel;
import net.oppakolba.mana_staffs.entity.projectile.BeamEntity;



public class BeamRenderer extends EntityRenderer<BeamEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(ManaStaffs.MOD_ID, "textures/entity/beam_texture.png");
