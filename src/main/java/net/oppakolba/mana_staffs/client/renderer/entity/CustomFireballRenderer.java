...
import net.oppakolba.mana_staffs.client.model.bolt.CustomFireballModel;
...
public class CustomFireballRenderer extends EntityRenderer<FireballEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(ManaStaffs.MOD_ID, "textures/entity/custom_fireball.png");
