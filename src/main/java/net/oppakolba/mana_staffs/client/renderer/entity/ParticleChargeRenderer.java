...
import net.oppakolba.mana_staffs.client.model.bolt.ParticleChargeModel;
...
public class ParticleChargeRenderer extends EntityRenderer<ParticleCharge> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("manastaffs", "textures/entity/particle_charge.png");
