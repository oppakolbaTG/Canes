...
import net.oppakolba.mana_staffs.client.renderer.particles.BeamExplosionParticle;
import net.oppakolba.mana_staffs.client.renderer.particles.BeamParticle;
import net.oppakolba.mana_staffs.client.renderer.particles.HealLineParticle;
import net.oppakolba.mana_staffs.client.renderer.particles.LightningParticle;
...
public class ParticleEvent {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
            ItemProperties.register(
                    ModItems.FIREBALL_STAFF.get(),
                    new ResourceLocation("manastaffs", "animation"),
