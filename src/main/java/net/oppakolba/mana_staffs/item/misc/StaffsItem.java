package net.oppakolba.mana_staffs.item.misc;
...
public class StaffsItem extends Item {
    int value;
    ...
    public StaffsItem(Properties pProperties, int value, int maxMana) {
        super(pProperties);
        this.value = value;
        this.maxMana = maxMana;
    }

    public StaffsItem(Properties properties, int maxMana) {
    ...
    protected static void updateManaForItem(ServerPlayer player, ItemStack stack, int slotId) {
