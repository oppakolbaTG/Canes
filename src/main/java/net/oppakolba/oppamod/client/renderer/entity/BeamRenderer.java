...
import net.oppakolba.oppamod.client.model.bolt.BeamEntityModel;
import net.oppakolba.oppamod.entity.projectile.BeamEntity;



public class BeamRenderer extends EntityRenderer<BeamEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Oppamod.MOD_ID, "textures/entity/beam_texture.png");
    ...
    public void render(BeamEntity entity, float pEntityYaw, float pPartialTick, PoseStack poseStack, MultiBufferSource buffer, int pPackedLight) {
        ...
        model.renderToBuffer(poseStack, buffer.getBuffer(RenderType.entityCutout(TEXTURE)), pPackedLight, OverlayTexture.NO_OVERLAY, 1f, 1f, 1f, 1f);
