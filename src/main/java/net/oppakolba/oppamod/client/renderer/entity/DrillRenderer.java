...
//import net.oppakolba.oppamod.client.model.bolt.DrilModel;
//import net.oppakolba.oppamod.entity.projectile.DrillEntity;
//
//public class DrillRenderer extends EntityRenderer<DrillEntity> {
//    public static final ResourceLocation TEXTURE = new ResourceLocation("oppamod", "textures/entity/drill_texture.png");
